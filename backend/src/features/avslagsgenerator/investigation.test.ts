...
test("kun en kildebegrunnet Reise Pluss-innvending gir overlevering", async () => {
  ...
  const valid = await investigate("Fiktiv vannskade", turns, "reisePluss", "neutral", true);
  ...
  const invalid = await investigate("Fiktiv vannskade", turns, "reisePluss", "neutral", true);
