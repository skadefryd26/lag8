...
const reise = (): Clause[] => [
  ...
  { id: "reise-svik", page: 17, section: "Generelle vilkår, 16. Svik", text: "Ved svik opphører retten til erstatning. Dette krever faktisk grunnlag for svik; en mistanke alene er ikke nok." },
  { id: "reise-leiebil", page: 8, section: "Leiebil/-motorsykkel", text: "Egenandelskrav ved skade eller tyveri av leid bil på feriereise med minst én overnatting kan dekkes hvis bilen er kaskoforsikret; privat leie og bildeling i Norge er unntatt." },
];
const innbo = (): Clause[] => [
  ...
  { id: "innbo-dyr", page: 3, section: "Hvilke skader?", text: "Standarddekningen unntar kjæledyrskader; uhellsdekningen på side 4 unntar også skade forårsaket av kjæledyr." },
  { id: "innbo-svik", page: 13, section: "Generelle vilkår, 16. Svik", text: "Ved svik opphører retten til erstatning. Dette krever faktisk grunnlag for svik; en mistanke alene er ikke nok." },
...
export function clausesFor(policyId: PolicyId): Clause[] {
  switch (policyId) {
    case "reisePluss": return reise();
    case "innboPluss": return innbo();
  }
}
